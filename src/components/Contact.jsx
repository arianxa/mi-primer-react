...
const Contact = () => {
  ...
  const cvUrl =
    i18n.language === "es"
      ? "/cv-arantxa-ordoyo-es.pdf"
      : "/cv-arantxa-ordoyo-en.pdf";
  ...
  return (
    ...
    { href: "mailto:pro.arantxa.ordoyo@gmail.com", icon: "mail", label: "pro.arantxa.ordoyo@gmail.com" },
                ...
                >
                  ...
                  <span className="font-label text-sm tracking-wide">
                    {link.label}
                  </span>
                </a>
              ))}
               <div className="w-full h-px bg-outline-variant/80 my-2">

  {/* CV aparte */}
  
   <a href={cvUrl}
    download
    className="group flex items-center gap-4 text-on-surface-variant hover:text-primary transition-colors my-5"
  >
   <span className="w-10 h-10 rounded-full bg-[#ede8e3] flex items-center justify-center group-hover:bg-[#d4c4b8] transition-colors">
  <span className="material-symbols-outlined text-sm text-[#6b4f3a]">download</span>
</span>
    <span className="font-label text-sm tracking-wide">{t("contact.download_cv")}</span>
  </a>
</div>
            </div>
          </div>
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label
                    className="font-label text-[10px] uppercase tracking-widest text-outline ml-1"
                    htmlFor="name"
                  >
                    {t("contact.name")}
                  </label>
              ...
              {status === "success" && (
                ...
                >
                  <span className="material-symbols-outlined text-[#535845] text-lg">
                    check_circle
                  </span>
